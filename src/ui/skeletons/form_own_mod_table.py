...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.btn_local_files = QtWidgets.QPushButton(Form)
        self.btn_local_files.setObjectName("btn_local_files")
        self.verticalLayout.addWidget(self.btn_local_files)
        self.btn_remote_files = QtWidgets.QPushButton(Form)
        self.btn_remote_files.setObjectName("btn_remote_files")
        self.verticalLayout.addWidget(self.btn_remote_files)
    ...
    def retranslateUi(self, Form):
        ...
        self.btn_remote_files.setText(_translate("Form", "Online Files"))
