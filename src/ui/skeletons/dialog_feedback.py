...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.comboBox.setItemText(0, _translate("Dialog", "Question"))
        self.comboBox.setItemText(1, _translate("Dialog", "Feature request"))
        self.comboBox.setItemText(2, _translate("Dialog", "Contact"))
