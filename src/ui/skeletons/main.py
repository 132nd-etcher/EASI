...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.main_buttons_layout = QtWidgets.QFrame(self.centralwidget)
        self.main_buttons_layout.setFrameShape(QtWidgets.QFrame.Box)
        self.main_buttons_layout.setFrameShadow(QtWidgets.QFrame.Plain)
        self.main_buttons_layout.setObjectName("main_buttons_layout")
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout(self.main_buttons_layout)
        self.horizontalLayout_4.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_4.setSpacing(1)
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.btn_mods = QtWidgets.QToolButton(self.main_buttons_layout)
        ...
        self.line = QtWidgets.QFrame(self.main_buttons_layout)
        self.line.setFrameShape(QtWidgets.QFrame.VLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.horizontalLayout_4.addWidget(self.line)
        self.btn_repos = QtWidgets.QToolButton(self.main_buttons_layout)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.line_2 = QtWidgets.QFrame(self.main_buttons_layout)
        self.line_2.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.horizontalLayout_4.addWidget(self.line_2)
        self.btn_editor = QtWidgets.QToolButton(self.main_buttons_layout)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.verticalLayout.addWidget(self.main_buttons_layout)
