...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        self.layout_cred_intro.setSpacing(20)
        self.layout_cred_intro.setObjectName("layout_cred_intro")
        self.label_cred_intro_pic = QtWidgets.QLabel(self.tab_credentials)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_cred_intro_pic.sizePolicy().hasHeightForWidth())
        self.label_cred_intro_pic.setSizePolicy(sizePolicy)
        ...
        self.label_cred_intro_pic.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.label_cred_intro_pic.setObjectName("label_cred_intro_pic")
        self.layout_cred_intro.addWidget(self.label_cred_intro_pic)
        self.label_cred_intro_text = QtWidgets.QLabel(self.tab_credentials)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_cred_intro_text.sizePolicy().hasHeightForWidth())
        self.label_cred_intro_text.setSizePolicy(sizePolicy)
        self.label_cred_intro_text.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        ...
        self.verticalLayout_4.addLayout(self.layout_cred_intro)
        ...
        self.layout_gh_create_token.addItem(spacerItem2)
